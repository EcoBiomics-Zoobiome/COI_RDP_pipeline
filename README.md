...
This repository outlines how Illumina MiSeq COI metabarcodes were processed for the GRDI: EcoBiomics - Soil Theme project by Teresita M. Porter. SCVUC refers to the programs, algorithms, and reference datasets used in this data flow: S=SEQPREP, C=CUTADAPT, V=VSEARCH, U=unoise, C=COI classifier.
